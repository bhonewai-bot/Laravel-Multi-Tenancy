@php
    ...
    $navLinks = $isTenant
        ...
        : [
            ['label' => 'Tenants', 'href' => route('tenants.index', absolute: false), 'active' => request()->routeIs('tenants.*')],
            ['label' => 'Modules', 'href' => route('modules.index', absolute: false), 'active' => request()->routeIs('modules.*')],
            ['label' => 'Module Requests', 'href' => route('module-requests.index', absolute: false), 'active' => request()->routeIs('module-requests.*')],
        ];
@endphp
