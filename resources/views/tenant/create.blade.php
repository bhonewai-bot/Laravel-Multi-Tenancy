<x-app-layout>
    <x-slot name="header">
        <x-page-header title="Create Tenant" />
    </x-slot>
                ...
                <div class="space-y-6">
                    ...
                    <div>
                        ...
                        <textarea id="description" name="description" rows="4"
                            class="mt-1 block w-full border-gray-300 dark:border-[#2a2a38] dark:bg-[#14141c] dark:text-gray-100 focus:border-brand-500 focus:ring-brand-500 dark:focus:border-brand-400 dark:focus:ring-brand-400 rounded-md shadow-sm">{{ old('description') }}</textarea>
