        ...
        <div class="w-full px-4 sm:px-6 lg:px-8">
            ...
            <!-- @if (session('onboarding_credentials'))
                <div class="mb-4 rounded-md border border-blue-200 bg-blue-50 p-4 text-sm text-blue-800">
                    Tenant <strong>{{ data_get(session('onboarding_credentials'), 'tenant_id') }}</strong> is ready.<br>
                    Admin email: <strong>{{ data_get(session('onboarding_credentials'), 'admin_email') }}</strong><br>
                    Password: use <strong>{{ data_get(session('onboarding_credentials'), 'password_source') }}</strong> from your `.env`.
                </div>
            @endif -->
