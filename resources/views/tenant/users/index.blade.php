            ...
            <x-slot name="actions">
                @can('create', App\Models\User::class)
                    <a href="{{ route('tenant.users.create', absolute: false) }}">
                        <x-primary-button type="button"><x-heroicon-o-plus class="w-4 h-4" /> Add User</x-primary-button>
                    </a>
                @endcan
            </x-slot>
        </x-page-header>
                                ...
                                <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-700 dark:text-gray-300">
                                    <div class="flex w-full justify-end">
                                        <x-dropdown align="right" width="w-40">
                                            <x-slot name="trigger">
                                                <button type="button"
                                                    class="inline-flex items-center gap-1 rounded-lg border border-gray-300 dark:border-[#262632] bg-white dark:bg-[#101016] px-3 py-2 text-xs font-semibold text-gray-700 dark:text-gray-300 shadow-card hover:bg-gray-50 dark:hover:bg-[#181820] transition-colors">
                                                    Action
