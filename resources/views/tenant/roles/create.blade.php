        ...
        <x-card>
            ...
            >
                ...
                <div>
                    ...
                    <div class="mt-3 overflow-hidden rounded-lg border border-gray-200 dark:border-[#2a2a38]">
                                            ...
                                            <div class="flex flex-wrap items-center gap-4 text-sm text-gray-700 dark:text-gray-300">
                                                <label class="inline-flex items-center gap-2 font-medium text-gray-900 dark:text-gray-100">
                                                    <input
                                                        ...
                                                        class="rounded border-gray-300 dark:border-[#2a2a38] text-brand-600 shadow-sm focus:ring-brand-500"
                                                        @change="toggleRow($el)"
                                                    >
